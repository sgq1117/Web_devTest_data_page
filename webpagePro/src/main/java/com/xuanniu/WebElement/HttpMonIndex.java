...
/**
 * @author sungq
 * @version 创建时间：2015年6月5日 上午10:19:41 类说明
 */

public class HttpMonIndex {
//	static String[] account = { "99913920001", "123456" };
	static String[] account = { "15313926589", "1234567" };
	
	/**
	 * 5000、3倍配资、4个月、1.9的利息
	 * @return
	 */
	...
	public static String CreateIndexJson() {
		...
		mapV21.put("页面", "配资");
		mapV21.put("动作", "page_click");
		mapV21.put("索引", "body > div.p-menu > div > div.menu.right.f16 > ul > li.li2 > a");
		...
		/*
		 * 配资比例 #swbox > div.multiple.left > div.tags > ul > li:nth-child(3) > div
		 */
		Map<String, String> mapV23 = new LinkedHashMap<String, String>();
		mapV23.put("页面", "月配资");
		mapV23.put("动作", "rate_click");
		mapV23.put("索引", "#swbox > div.multiple.left > div.tags > ul > li:nth-child(2) > div");

		Map<String, String> mapV24 = new LinkedHashMap<String, String>();
		mapV24.put("页面", "月配资");
		mapV24.put("动作", "usedate_click");
		mapV24.put("索引", "#swbox > div.confirm.right > div.table > table > tbody > tr:nth-child(5) > td:nth-child(2) > select > option:nth-child(4)");

		Map<String, String> mapV25 = new LinkedHashMap<String, String>();
		mapV25.put("页面", "月配资");
		mapV25.put("动作", "interest_send");
		mapV25.put("索引", "#swbox > div.confirm.right > div.table > table > tbody > tr:nth-child(6) > td:nth-child(2) > input");
		mapV25.put("数值", "1.9");
		...
		mapV31.put("页面", "确认");
		mapV31.put("动作", "tradeAccount_click");
		mapV31.put("索引", "#tradeAccountApplyWay > option:nth-child(2)");

		Map<String, String> mapV32 = new LinkedHashMap<String, String>();
		mapV32.put("页面", "确认");
		mapV32.put("动作", "coupon_click");
		mapV32.put("索引", "#giftSelect > option");

		Map<String, String> mapV33 = new LinkedHashMap<String, String>();
		mapV33.put("页面", "确认");
		mapV33.put("动作", "sure_click");
		mapV33.put("索引", "	#button");
		// -------------审核---------
	...
	public static void getJson(String jsonString) {
		...
		for (int i = 0; i < ja.size(); i++) {
			...
			if (action.contains("_send")) {
				System.out.println("val: " + ja.getJSONObject(i).getString("数值"));
			}
		}
	}
...
//		CreateIndexJson();
		 getJson(CreateIndexJson());

		// String mapV1 = "aa";
		// String mapV2 = "bb";
		//
		// for ( int i=1; i<3; i++) {
		// System.out.println("mapV"+i);
		// }
	}
}
//